...
async function generateClaudeDraft(input: {
  ...
  const prompt = [
    ...
    "PROIBIDO: bullets, listas numeradas, travessoes (—), emojis, markdown, titulos em negrito.",
    ...
    "Se algum dado estiver fraco ou ausente, diga diretamente e com cuidado, sem drama.",
    ...
    "3. O que foi positivo — com dado especifico.",
    "4. O que precisa ajustar — honesto sem drama, com o motivo.",
